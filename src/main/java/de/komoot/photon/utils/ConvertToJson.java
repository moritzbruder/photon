...
public class ConvertToJson implements OneWayConverter<SearchResponse, List<JSONObject>> {
    private final static String[] KEYS_LANG_UNSPEC = {Constants.OSM_ID, Constants.CITY_ID, Constants.OSM_VALUE, Constants.OSM_KEY, Constants.POSTCODE, Constants.HOUSENUMBER, Constants.OSM_TYPE};
