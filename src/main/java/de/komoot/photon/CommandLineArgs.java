...
public class CommandLineArgs {
    ...
    @Parameter(names = "-import-minimal-details", description = "import nominatim database and export to elasticsearch with a minimal dataset (no place name, street name etc.). This is useful to create a smaller dataset if you just want to reverse-geocode for the city_id of some place.")
